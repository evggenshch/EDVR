...
def main():
    ...
    for subfolder, subfolder_GT in zip(subfolder_l, subfolder_GT_l):
        ...
        for img_idx, img_path in enumerate(img_path_l):
            ...
            logger.info('{:3d} - {:25} \tSSIM: {:.6f} dB'.format(img_idx + 1, img_name, crt_ssim))
        ...
        logger.info('Folder {} - Average SSIM: {:.6f} dB for {} frames; '
                    ...
                    'Border SSIM: {:.6f} dB for {} frames.'.format(subfolder_name, avg_ssim,
                                                                   (N_center + N_border),
    ...
    for subfolder_name, ssim, ssim_center, ssim_border in zip(subfolder_name_l, avg_ssim_l,
        ...
        logger.info('Folder {} - Average SSIM: {:.6f} dB. '
                    'Center SSIM: {:.6f} dB. '
                    'Border SSIM: {:.6f} dB.'.format(subfolder_name, ssim, ssim_center,
                                                     ssim_border))
